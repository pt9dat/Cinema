...
class DSPhimTBVC:  UIViewController, UISearchBarDelegate, UITableViewDelegate {
  ...
  override func viewWillAppear(_ animated: Bool) {
    ...
    parseJSON()
    print("reload Data")
    if let _ = DangNhapVC.userDefault.string(forKey: "userID") {
  ...
  static func dateConvert(date: Double) -> String {
  ...
  static func downloadImage(posterUrl:String, imgView: UIImageView) {
    ...
    //            DSPhimTBVC.getData(from: url) { data, response, error in
...
extension DSPhimTBVC: UITableViewDataSource {
  ...
  func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
    ...
    cell.dateTF.text = DSPhimTBVC.dateConvert(date: phim.release)
    DSPhimTBVC.downloadImage(posterUrl: phim.cover, imgView: cell.imgIV)
    return cell
  }
}
