...
public class CreateMovie {
    ...
    String pass = "1111";
    String title = "dat phim 14";


    public CreateMovie(IOSDriver iosDriver) {
    ...
    public void testCreateMovie () {
        ...
        tenPhimTF.sendKeys("dat phim 15");
        hideKbBtn.click();
        theLoaiTF.click();
...
//        iosDriver.findElementByXPath("Set date");
        ...
        moTaTV.sendKeys("mo ta phim dat 13");
        hideKbBtn.click();
        taoPhimBtn.click();
        try {
            Thread.sleep(40000);
        ...
        if (cellTenPhimLbl.getText().equals(title) && cellNguoiTaoLbl.getText().equals("dat2")) {
            System.out.println("co phim vua tao: "+cellTenPhimLbl.getText());
